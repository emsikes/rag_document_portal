...
class ModelLoader:
    """
    Utility class that loads embedding models and LLMs
    """
    def __init__(self):
        """
    ...
    def _validate_env(self):
        """
        Validate environment varaibles and verify API keys 
        """
        ...
        log.info("Environment variables successfully validated", available_keys=[k for k in self.api_keys if self.api_keys[k]])
    ...
    def load_embeddings(self):
        ...
        try:
            ...
            raise DocumentPortalException("Error loading the embedding model", sys)
...
if __name__ == "__main__":
    ...
    # Test LLM loading successful based on config
    llm = loader.load_llm()
